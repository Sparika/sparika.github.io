...
fn secure() -> Html {
    ...
    let onclick_kcorre_callback = {
        let navigator = navigator.clone();
        Callback::from(move |_| navigator.push(&Route::Kcorre))
    };
    ...
    html! {
        <nav class="nav-container">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" onclick={ onclick_kcorre_callback }>
                        {"/kcorre"}
                    </a>
                </li>
                <li class="nav-item">
